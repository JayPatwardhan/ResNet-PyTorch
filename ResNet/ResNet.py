...
class ResNet(nn.Module):
    ...
    def _make_layer(self, ResBlock, blocks, planes, stride=1):
        ...
        layers.append(ResBlock(self.in_channels, planes, i_downsample, stride))
...
def ResNet101(num_classes, channels=3):
    return ResNet(ResBlock, [3,4,23,3], num_classes, channels)

def ResNet152(num_classes, channels=3):
    return ResNet(ResBlock, [3,8,36,3], num_classes, channels)
